...
var (
	...
	// Blond is the color of unfinished wood.
	Blond = ansi.RGB(0xd8, 0xa8, 0x39)
	// Brown is the color of stained wood.
	Brown = ansi.RGB(0x4e, 0x2c, 0x0a)
	// Black is the color of very dark stained wood.
	...
	Green = ansi.RGB(0x1f, 0x7f, 0x1f)
	// Red is the color of cherry red plastic furniture.
	Red = ansi.RGB(0x7f, 0x1f, 0x1f)
	// Aisle is the color of the BØRK aisle flooring.
	Aisle = ansi.RGB(0x9f, 0x9f, 0x9f)
